...
PCA (Figure 4A in the manuscript). A '**+**' indicates that a variable
...
variables loaded onto PC2 from the label PCA (Figure 4B in the
manuscript).
...
#| echo: false
# Combine label PC loadings for Figure 4A and Figure 4B in the manuscript
PC1_loadings_comb <-
...
most associated with the perceptually high and low SES groups (Figure 4C
in the manuscript) and the with the perceptually fast/high and slow/low
groups (Figure 4B in the manuscript).
...
@fig-PC2Loadings, and @fig-PCA-perceptual-groups to make Figure 4 from
the manuscript.
...
# Done to improve readability of Figure 7A
...
PCA (Figure 6C in the manuscript). We can discern four main overlaps in
...
data from the same stimuli. This section contains code for Figures 7 and
8 from the manuscript, which compare *perceptually high/low SES* and
...
different leader-lagger vowels (Figure 7 in the manuscript). The
...
different speed and pitch (Figure 8 from the manuscript). Slow, but
