...
the file `Matrix-generation-script.qmd` in the github repository or view
the file
[here](https://nzilbb.github.io/qb-free-classification-public/Scripts/Matrix-generation-script.html).
